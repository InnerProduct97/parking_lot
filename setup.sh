#!/bin/bash
# Generate a string to run this script many times
timestamp=$(date +%s)

# Set your desired region and role details
region="us-east-1"
role_name="RekognitionFullAccess_$timestamp"
policy_name="RekognitionFullAccess-policy_$timestamp"
...
key_name="WebServer_Security_$timestamp"
instance_name="WebServer_$timestamp"
deploy_script="deploy.sh"

# Set your desired region and security group details
security_group_name="web_server_sg_$timestamp"
